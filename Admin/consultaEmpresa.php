   ...
   <script>
    $(document).ready(function(){
      ...
      <section class="charts">
        <div class="container-fluid">
          <header> 
            <h1 class="h3">Registro de empresa</h1>
          </header>
          <div class="row">           
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header d-flex align-items-center">
                  <h2 class="h5 display">Tabela de relação de empresa</h2>
                </div>
				...
				<tbody>
					<?php
						...
						$sql = "select * from empresa where disponivel='S' order by id_empresa";
						...
						while($linha = $resultado->fetch_object())
						{
							...
							echo "<tr>
									...
									<td><a href=\"alterarEmpresa.php?id=$linha->id_empresa\"><button type='button' class='btn btn-warning'>Alterar</button></a></td> 
