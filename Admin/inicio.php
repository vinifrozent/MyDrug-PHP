    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          <div class="sidenav-header-inner text-center"><img src="<?php echo $teste; ?>" alt="Sem Foto" class="img-fluid rounded-circle">
          ...
          <ul id="side-admin-menu" class="side-menu list-unstyled"> 
            <li> <a href="#pages-nav-list" data-toggle="collapse" aria-expanded="false"><i class="icon-interface-windows"></i><span>Ações</span>
              ...
              <ul id="pages-nav-list" class="collapse list-unstyled">
                <li> <a href="cadastroEmpresa.php">Cadastro pendente</a></li>
                <li> <a href="consultaEmpresa.php">Consulta Empresa</a></li>
                <li> <a href="cadastroProduto.php">Cadastro Produtos</a></li>
                <li> <a href="consultaProduto.php">Consulta Produtos</a></li>
                <li> <a href="cadastroUsuario.php">Cadastro Usuários</a></li>
                <li> <a href="consultaUsuario.php">Consulta Usuários</a></li>
                <li> <a href="consultaClientes.php">Consulta Clientes</a></li>
              </ul>
            </li>
