            ...
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-block">
                  ...
                  <form action="confirmaAlterarEmpresa.php" method="post" enctype="multipart/form-data" align="auto">
					<div class="form-group">
                      <label>ID do usuário</label>
					  <?php echo "ID: <input name=\"id\" readonly=\"true\" type=\"text\" value=\"$linha->id_empresa\" class='form-control'>";?>
                      
                    </div>
					
                    <div class="form-group">
                      <label>Nome do responsável</label>
                      <input type="text" placeholder="Nome Completo" value="<?php echo $linha->nome_responsavel;?>" name="nome_responsavel" class="form-control">
                    </div>
					
					<div class="form-group">
                      <label>Telefone do usuário</label>
                      <input type="text" placeholder="Telefone" value="<?php echo $linha->telefone_responsavel;?>"name="telefone" id="telefone" class="form-control" onkeypress="mascara(this, '## ####-####')" maxlength="12">
					  
                    </div>
					
					<div class="form-group">
                      <label>E-mail</label>
                      <input type="email" placeholder="E-mail" value="<?php echo $linha->email_responsavel;?>"name="email" class="form-control">
                    </div>
					<div class="form-group">
					<div class="form-group">
