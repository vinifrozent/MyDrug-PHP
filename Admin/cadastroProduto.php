            ...
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-block">
                  ...
                  <form action="confirmaProduto.php" method="post" enctype="multipart/form-data" align="auto">
                    <div class="form-group">
                      <label>Nome do produto</label>
                      <input type="text" placeholder="Nome do produto" name="nome" class="form-control">
                    </div>
					...
					<div class="form-group">
                      ...
                      <input type="text" placeholder="Quantidade em estoque" name="quantidade" onkeyup="somenteNumeros(this);" maxlength="7" class="form-control">
                    </div>
                      <div class="form-group">
                      <label>Quantidade Mínima para venda</label>
                      <input type="text" placeholder="Quantidade Miníma para venda" name="quantidade_min" onkeyup="somenteNumeros(this);" maxlength="7" class="form-control">
                    </div>
                      <div class="form-group">
