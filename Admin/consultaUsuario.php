              ...
              <div class="card">
				...
				<tbody>
					<?php
						...
						$sql = "select * from usuarios where disponivel= 'S' order by id ";
						...
						while($linha = $resultado->fetch_object())
						{
							...
							echo "<tr>
									...
									<td><button type=\"button\"  class=\"btn btn-danger btn_excluir\" id=\"$linha->id\"><span class=\"glyphicon glyphicon-remove\"></span> Excluir</button></td>
									
									<td><a href=\"alterarUsuario.php?id=$linha->id\"><button type='button' class='btn btn-warning'>Alterar</button></a></td> 
