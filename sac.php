			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 animate-box">
						<figure>
							<img src="images/logo_mydrug.png" alt="Free HTML5 Bootstrap Template by FREEHTML5.co" class="img-responsive">
						</figure>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6 animate-box">
						<p>A Mydrug é uma empresa no ramo da saúde que está há 1 ano no mercado e busca sempre trazer o melhor para seus clientes, contando com serviço de entrega de medicamentos a domicílio. oferecemos Home-care 24h para o máximo de conforto para nossos clientes. </p>
					</div>
					<div class="col-md-6 animate-box">
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="fh5co-testimonial text-center animate-box">
							...
							<blockquote>
								<p>“A arte da medicina consiste em distrair o paciente enquanto a natureza cuda da doença.”</p>
							</blockquote>
							<span>Voltarie, Poeta.</span>
						</div>
					</div>
					<div class="col-md-6 col-sm-6">
